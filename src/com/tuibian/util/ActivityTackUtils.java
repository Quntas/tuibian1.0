 ...
 * 
 */
public class ActivityTackUtils {

	public List<Activity> activityList = new ArrayList<Activity>();

	public static ActivityTackUtils tack = new ActivityTackUtils();

	public static ActivityTackUtils getInstanse() {
		return tack;
	}

	private ActivityTackUtils() {
